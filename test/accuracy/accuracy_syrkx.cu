...
#include "accuracy_syrkx.hpp"

namespace bench::accuracy::syrkx {
...
void check_accuracy(
    ...
    if (uplo != CUBLAS_FILL_MODE_UPPER &&
        ...
        assert(false && "SYRKX requires uplo = UPPER or LOWER.");
        return;
    }
