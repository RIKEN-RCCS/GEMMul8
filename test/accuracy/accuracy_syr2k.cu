...
void check_accuracy(
    ...
    if (uplo != CUBLAS_FILL_MODE_UPPER &&
        ...
        assert(false && "SYR2K requires uplo = UPPER or LOWER.");
        return;
    }
