...
#include "accuracy_syrk.hpp"

namespace bench::accuracy::syrk {
...
void check_accuracy(
    ...
    if (uplo != CUBLAS_FILL_MODE_UPPER &&
        ...
        assert(false && "SYRK requires uplo = UPPER or LOWER.");
        return;
    }
