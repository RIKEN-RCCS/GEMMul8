...
void check_accuracy(
    ...
    lwork_gemmul8_i8_ = gemmul8::workSize<testTraits<T>::is_complex, gemmul8::Backend::INT8, func>(m_max, n_max, k_max, num_moduli_max);
#endif
#if GEMMUL8_BUILD_FP8
    lwork_gemmul8_f8_ = gemmul8::workSize<testTraits<T>::is_complex, gemmul8::Backend::FP8, func>(m_max, n_max, k_max, num_moduli_max);
#endif
