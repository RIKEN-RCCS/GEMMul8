...
void check_accuracy(
    ...
    lwork_gemmul8_i8_ = gemmul8::workSizeTrsm<T, gemmul8::Backend::INT8>(handle, side, m_max, n_max, num_moduli_max);
#endif
#if GEMMUL8_BUILD_FP8
    lwork_gemmul8_f8_ = gemmul8::workSizeTrsmLt<T, gemmul8::Backend::FP8>(handleLt, side, m_max, n_max, num_moduli_max);
#endif
